#ifndef PREFETCHER_IP_STRIDE_CHERI_DYNAMIC_H
#define PREFETCHER_IP_STRIDE_CHERI_DYNAMIC_H
...
struct ip_stride_cheri_dynamic : public champsim::modules::prefetcher {
  ...
  constexpr static int MAX_PREFETCH_DEGREE = 6;
  ...
  uint64_t cap_degree_reduced{};     // degree clipped below MAX
  uint64_t cap_degree_increased{};   // degree above old fixed 4
  uint64_t total_degree_sum{};       // for computing average
  uint64_t total_degree_count{};
