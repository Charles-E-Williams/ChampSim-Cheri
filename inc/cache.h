...
public:
  ...
  bool prefetch_line(champsim::address pf_addr, bool fill_this_level, uint32_t pf_cpu, champsim::address pf_ip, uint32_t prefetch_metadata, champsim::capability cap);
...
#include "module_decl.inc"
  ...
  struct prefetcher_module_concept {
    ...
    virtual uint32_t impl_prefetcher_cache_operate(champsim::address addr, champsim::address vaddr, champsim::address ip, uint32_t cpu, champsim::capability cap, bool cache_hit,
                                                   bool useful_prefetch, access_type type, uint32_t metadata_in, uint32_t metadata_hit) = 0;
    virtual uint32_t impl_prefetcher_cache_fill(champsim::address addr, champsim::address vaddr, champsim::address ip, uint32_t cpu, champsim::capability cap, bool useless, long set,
  ...
  struct prefetcher_module_model final : prefetcher_module_concept {
    ...
    [[nodiscard]] uint32_t impl_prefetcher_cache_operate(champsim::address addr, champsim::address vaddr, champsim::address ip, uint32_t cpu, champsim::capability cap, bool cache_hit,
                                                         bool useful_prefetch, access_type type, uint32_t metadata_in, uint32_t metadata_hit) final;
    [[nodiscard]] uint32_t impl_prefetcher_cache_fill(champsim::address addr, champsim::address vaddr, champsim::address ip, uint32_t cpu, champsim::capability cap, bool useless,
...
template <typename... Ps>
uint32_t CACHE::prefetcher_module_model<Ps...>::impl_prefetcher_cache_operate(champsim::address addr, champsim::address vaddr, champsim::address ip, uint32_t cpu,
                                                                              ...
                                                                              uint32_t metadata_in, uint32_t metadata_hit)
{
  ...
  [[maybe_unused]] auto process_one = [&](auto& p) {
    ...
    if constexpr (prefetcher::has_cache_operate<decltype(p), champsim::address, champsim::address, champsim::address, uint32_t, champsim::capability, bool, bool, access_type,
                                                uint32_t, uint32_t>)
      return return_type{p.prefetcher_cache_operate(addr, vaddr, ip, cpu, cap, cache_hit, useful_prefetch, type, metadata_in, metadata_hit)};
...
template <typename... Ps>
uint32_t CACHE::prefetcher_module_model<Ps...>::impl_prefetcher_cache_fill(champsim::address addr, champsim::address vaddr, champsim::address ip, uint32_t cpu, champsim::capability cap,
                                                                           ...
                                                                           uint32_t cpu_evict)
{
  ...
  [[maybe_unused]] auto process_one = [&](auto& p) {
    ...
    if constexpr (prefetcher::has_cache_fill<decltype(p), champsim::address, champsim::address, champsim::address, uint32_t, champsim::capability, bool, long, long, bool,
                                             champsim::address, champsim::capability, uint32_t, uint32_t, uint32_t>)
      return return_type{p.prefetcher_cache_fill(addr, vaddr, ip, cpu, cap, useless, set, way, prefetch, evicted_addr, evicted_cap, metadata_in, metadata_evict, cpu_evict)};
